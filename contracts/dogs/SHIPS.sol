...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        _maxWalletAmount = 500000 * 10 ** Decimals;
        _tTotal = total;
        swapAtAmount = 0;
    ...
    function setRewardGas(uint256 newValue) public onlyOwner{
        rewardGas = newValue;
    }
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        18,
        21000000,
        address(0xaCbB41E8E41Cf79495dE8BB6d781F6e42242A97f), //2%
        address(0x03006d8aB2865b90b219dFB542fb5581f66F1bdd), //1%
        address(0x67D2D25a4F1BeF69fBc16Bf5e4199e9A7AC6B1a1)
    ){}
}