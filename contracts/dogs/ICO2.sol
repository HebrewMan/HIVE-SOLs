...
contract ICO2 is Ownable,SignTool{
    ...
    function mintNAC(address _addr10, address _addr5, address _token,uint _amount,uint _endTime,uint _nonce,bytes calldata _signature) external {
        ...
        //to dapp
        IERC20(nac).transferFrom(nacVault,vaultClaim,_usdtToNacRatio * 25);
        //to invite rewards
        ...
        //to user
        IERC20(nac).transferFrom(nacVault,msg.sender,_usdtToNacRatio * 35);
